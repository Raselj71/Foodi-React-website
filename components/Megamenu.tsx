...
function Megamenu({ image, heading, des }: propstype) {
  return (
    <div className="w-[150px] h-[150px] lg:w-[277px] lg:h-[300px]  md:w-[210px] md:h-[210px] px-2 py-2   lg:p-4 lg:py-2 md:p-8 drop-shadow-2xl rounded-[30px] bg-white flex flex-col justify-center items-center">
